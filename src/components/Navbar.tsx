...
import { PenSquare, LogOut, LogIn, UserPlus, BookOpen, Moon, Sun, User, ChevronDown, Settings } from 'lucide-react';
          ...
          {user ? (
            <div className="flex flex-col space-y-4">
              ...
              <Link
                ...
                className="flex items-center p-3 rounded-lg hover:bg-secondary-50 dark:hover:bg-secondary-800/50 text-secondary-700 dark:text-secondary-300"
              >
                <Settings size={18} className="mr-3 text-primary-600 dark:text-primary-400" />
                <span>Settings</span>
              </Link>
