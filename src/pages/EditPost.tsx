        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="border rounded-lg overflow-hidden border-secondary-200 dark:border-secondary-700 focus-within:border-primary-500 dark:focus-within:border-primary-400 transition-colors">
              ...
              <div className="p-6 bg-white dark:bg-secondary-800 min-h-[400px]">
                <EditorContent 
                  editor={editor}
                  className="[&_.ProseMirror]:outline-none [&_.ProseMirror]:min-h-[360px] [&_.ProseMirror_p]:leading-relaxed [&_.ProseMirror_p]:mb-4 [&_.ProseMirror]:w-full"
                />
              </div>
            </div>
          </div>
